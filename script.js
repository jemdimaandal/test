const batangasLocations = [
    {
        ...
        lat: 13.63664,
        lng: 121.32747,
        address: "Laiya Rd, Lobo, 4229 Batangas",
        description: "Taal Lake is a freshwater caldera lake in the province of Batangas. The lake fills Taal Volcano, a large volcanic caldera formed by very large eruptions. Home to Taal Volcano, one of the most active volcanoes in the Philippines, this scenic lake offers breathtaking views and unique geological formations.",
        rating: 5,
        panorama: "Photos/Malabrigo/360.jpg",
        photos: [
            {
                title: "Taal Lake Panorama",
                url: "Photos/Malabrigo/1.png"
            },
            {
                title: "Volcano Island View",
                url: "Photos/Malabrigo/2.png"
            }
        ]
    },
    {
        ...
        lat: 13.63296,
        lng: 121.07008,
        address: "J5PW+48C, Lobo-Ilijan-Batangas City Road, Lobo, Batangas",
        description: "Mt. Maculot is a popular hiking destination known for its iconic Rockies formation and stunning panoramic views of Taal Lake. Standing at 930 meters above sea level, this mountain offers challenging trails for beginner to intermediate hikers, with the reward of spectacular sunrise and sunset views.",
        rating: 5,
        panorama: "Photos/Ilijan/360.jpg",
        photos: [
            {
                title: "Rocky Summit",
                url: "Photos/Ilijan/1.png"
            }
        ]
    },
    {
        id: 3,
        name: "Sitio Ilaya, Mabilog na Bundok",
        lat: 13.650307,
        lng: 121.229862,
        address: "M62F+6VV, Sitio Ilaya, Mabilog Na Bundok, Lobo, Batangas",
        description: "Anilao is renowned as the birthplace of scuba diving in the Philippines and is considered one of the world's top macro photography diving destinations. With crystal-clear waters, vibrant coral reefs, and diverse marine life including nudibranchs, pygmy seahorses, and colorful reef fish, Anilao offers an underwater paradise for divers of all levels.",
        rating: 5,
        panorama: "Photos/Sitio Ilaya/360.jpg",
        photos: [
            {
                title: "Coral Reef",
                url: "Photos/Sitio Ilaya/1.png"
            }
        ]
    },
    {
...
function populateLocationsList() {
    ...
    batangasLocations.forEach((location, index) => {
