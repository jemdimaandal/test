...
function showLocationDetails(locationId) {
    ...
    if (avatarGuide && avatarSpeech) {
        avatarSpeech.textContent = `Welcome to ${location.name}!`;
        avatarGuide.classList.add('active');
    }
}
...
function closeInfoPanel() {
    ...
    const avatarGuide = document.getElementById('avatar-guide');
    if (avatarGuide) {
        avatarGuide.classList.remove('active');
    }
}
...
function toggleSidebar() {
    ...
    // Toggle body class for styling hooks
